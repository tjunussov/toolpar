...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ui="ui" xmlns:e="entity" xmlns:xhtml="xhtml" xmlns:page="page" xmlns:exslt="http://exslt.org/common" exclude-result-prefixes="exslt page e ui html xhtml">
    ...
    <xsl:template match="ui:menu" name="ui:menu">
       ...
       <ul class="menu">
        ...
        <h3 class="uppercase">Финансы</h3>

        <ul class="menu">
	        <li>
                <input type="radio" id="ux-menu-CHECK" name="ux-menu"/>
                <label for="ux-menu-CHECK" href="#/transports/transport-arrival"><i class="icon-directions"></i>Чеки</label>            
                <ul>
                    <li><a href="#/catalog/department" data-translate="sidebar.catalogs.common.departments">Открытые чеки</a></li>
		            <li><a href="#/catalog/country" data-translate="sidebar.catalogs.common.countries">Архив чеков</a></li>
                    <li><a href="#/sorting/transport-list">Сторнированные</a></li>
                </ul>
            </li>
